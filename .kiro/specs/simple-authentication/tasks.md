...
- [ ] 5. Routerのナビゲーションガード設定
  - [ ] 5.1 ルート定義とナビゲーションガードの実装
...
- [ ] 6. Checkpoint - コア機能の動作確認
  - すべてのテストが通ることを確認
  - サインイン・サインアウトの基本フローが動作することを確認
  - 質問があればユーザーに確認

- [ ] 7. Layoutコンポーネントへのサインアウトボタン追加
  - [ ] 7.1 Layoutコンポーネントの修正
